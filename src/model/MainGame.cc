...
//}
//
//logic::MainGame::MainGame(sf::RenderWindow& i_window) : window(i_window){
//    REQUIRE(&i_window != nullptr, "Window doesnt exist");
//    this->draw = std::make_unique<Draw>(i_window);
//    this->field = std::make_unique<World>(glm::vec4(10, 10, 10, 0), 5);
...
//
////MainGame::MainGame() {
////    this->field = std::make_unique<World>(glm::vec4(600,600,600), 5);
////}
//
//void logic::MainGame::Play() {
